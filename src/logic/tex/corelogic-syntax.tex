...
\item \code{condu}:
(Commited choice) Soblad der \dq{}HEAD\dq{} einer Bedingungsanweisung erfolgreich ist, ŵerden die verbleibenden \dq{}goals\dq{} der Anweisung nur einmal ausgeführt. \code{condu} ist nicht-relational.
